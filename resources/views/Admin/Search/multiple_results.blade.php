                                                ...
                                                <tbody>
                                                    @foreach ($result as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="badge badge-outline-warning">Under payment
                                                                </div>
                                                            </td>

                                                            <td><a href="{{ 'add-reciept/' . $item->id }}"
                                                                    class="btn btn-outline-primary btn-icon-text">
                                                                    <i class="mdi mdi-eye btn-icon-prepend"></i> Make
                                                                    reciept </a> </td>
                                                            ...
                                                            <td><a href="{{ 'attach-receipt/' . $item->id }}"
                                                                    class="btn btn-outline-primary btn-primary-text">
                                                                    <i class="mdi mdi-eye btn-icon-prepend"></i> Upload
                                                                    receipt </a> </td>

                                                            <td><a href="{{ 'add-agreement/' . $item->id }}"
