                    ...
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-right font-weight-medium"> {{$data->method_payment}} </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right font-weight-medium">
                                                                    {{ $data->purchase_type }} </td>
                                                            </tr>

                                                            <tr>
                                                                <td class="text-info">Amount paid</td>
                                                                <td class="text-right font-weight-medium">
                                                                    {{ $data->amount_payed }} </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if ($data->next_installment_pay == 'Fully payed')
                                                                    <td class="text-right font-weight-medium">
                                                                        {{ $data->next_installment_pay }} </td>
                                                                @elseif ($data->next_installment_pay == 'Resold')
                                                                    <td class="text-right font-weight-medium">
                                                                        {{ $data->next_installment_pay }}</td>
                                                                @else
                                                                    <td class="text-right font-weight-medium">Under
                                                                        payment</td>
                                                                @endif
                                                            </tr>
                                            ...
                                            <div class="col-md-7">
                                                <div id="audience-map" class="vector-map">
                                                    <img style="width: 100%; height:100%"
                                                        src="{{ '/public/national_id/' . $data->national_id_front }}"
                                                        alt="">
                                                </div>

                                                <div id="audience-map" class="vector-map">
                                                    <img style="width: 100%; height:100%"
                                                        src="{{ '/public/national_id/' . $data->national_id_back }}"
                                                        alt="">
                                                </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="center_align_div col-md-9" style="padding-left: 10rem">

                                    @foreach ($user_reciepts as $key => $user_receipt)
                                        <br> <br>
                                        <img style="width: 100%; "
                                            src="{{ '/public/receipts/' . $user_receipt->receipt }}" alt="">
                                    @endforeach
                                </div>
                                ...
                                <div class="center_align_div col-md-9" style="padding-left: 10rem">
                                    @foreach ($user_agreements as $user_agreement)
                                        <br> <br>
                                        <img style="width: 100%; "
                                            src="{{ '/public/agreements/' . $user_agreement->agreement }}"
                                            alt="">
                                    @endforeach
                                </div>
                                ...
                                <div class="center_align_div col-md-9" style="padding-left: 10rem">
                                    @foreach ($user_agreements_uploaded as $user_agreement)
                                        <br> <br>
                                        <img style="width: 100%; "
                                            src="{{ '/agreements/' . $user_agreement->agreement }}" alt="">
                                    @endforeach
                                </div>
