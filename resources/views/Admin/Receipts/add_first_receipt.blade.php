    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add First Reciept :</h4>
                        ...
                        <form class="form-sample" id="myForm" action="{{ route('store-first-receipt') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="amount_paid" id="amount_paid"
                                                value="{{ old('amount_paid') }}" class="form-control" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="Date_of_payment" id="Date_of_payment"
                                                value="{{ old('Date_of_payment') }}" class="form-control" required>
                                            <span class="text-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" name="balance_pending" id="balance_pending"
                                                value="{{ old('balance_pending') }}" class="form-control" required>
                                            <span class="text-danger">
                                                @error('balance_pending')
                                                    {{ $message }}
                                                @enderror
                                            </span>
