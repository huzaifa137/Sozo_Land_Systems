                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="d-flex align-items-center align-self-start">
                                    <h3 class="mb-0">{{$Plots_with_posters}}</h3>
                                </div>
                            </div>

                        </div>
                        <h6 class="text-muted font-weight-normal">Total plots with pending posters</h6>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-9">
                                <div class="d-flex align-items-center align-self-start">
                                    <h3 class="mb-0">{{$Plots_without_posters}}</h3>
                                </div>
                            </div>
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Search Bar -->
                        <input type="text" id="searchBar" placeholder="Search estates by name..."
                            ...
                            <table class="table" id="estatesTable">
                                ...
                                <tbody>
                                    @foreach ($estates as $key => $item)
                                        <tr>
                                            <td><a href="{{ url('view-estate-posters/' . $item->id) }}"> {{ $key + 1 }} </a>
                                            </td>
                                            <td><a href="{{ url('view-estate-posters/' . $item->id) }}"> {{ $item->estate_name }}
                                                </a></td>
                                            <td><a href="{{ url('view-estate-posters/' . $item->id) }}"> {{ $item->estate_price }}
                                                </a></td>
                                            <td><a href="{{ url('view-estate-posters/' . $item->id) }}"> {{ $item->location }}
                                                </a></td>
                                            <td><a href="{{ url('view-estate-posters/' . $item->id) }}">
                                                    {{ $item->number_of_plots }} </a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
