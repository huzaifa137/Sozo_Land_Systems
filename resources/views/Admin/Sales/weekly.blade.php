                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <img style="width: 100%; height:100%" src="{{'/public/public/national_id/'.$weeklyRecord->national_id_front}}" alt="" id="week_img">
                              <span class="ps-2">{{$weeklyRecord->firstname}}</span>
                                </a>
                            </td>

                            
                            <td><a href="{{'view-reciept/'.$weeklyRecord->id}}"> {{$weeklyRecord->estate}}  </a></td>
                            <td><a href="{{'view-reciept/'.$weeklyRecord->id}}"> {{$weeklyRecord->plot_number}} </a></td>
                            <td><a href="{{'view-reciept/'.$weeklyRecord->id}}"> {{$weeklyRecord->method_payment}} </a></td>
                            <td><a href="{{'view-reciept/'.$weeklyRecord->id}}"> {{$weeklyRecord->amount_payed}} </a></td>
                            <td><a href="{{'view-reciept/'.$weeklyRecord->id}}"> {{$weeklyRecord->balance}} </a></td>
