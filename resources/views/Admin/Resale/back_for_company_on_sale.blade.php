          ...
          <div class="content-wrapper">
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Plots back on market for sale by company </h4>
                    <div class="table-responsive">
                      ...
                      @foreach ($sell_for_client as $key => $item)
                        ...
                        <tr>
                          <td>{{$key+1}}</td>
                            ...
                            <td><i class="btn btn-success">Plot Available</i></td>
                            {{-- <td><a href="{{'view-estate/'.$item->id}}"><i class="btn btn-success">View Plot Information</i></a></td> --}}
                          </tr>
                          @endforeach    
                        </tbody>
                      </table>
