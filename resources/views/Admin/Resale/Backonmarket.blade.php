              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    <h3 class="mb-0">{{$count_resold_to_company_in_cash}}</h3>
                  </div>
                </div>
                <div class="col-3">
                  <!-- Add any icons or elements if necessary -->
                </div>
              </div>
              <h6 class="text-muted font-weight-normal">Plots bought with hard cash</h6>
            </div>
          </a>
        </div>
      </div>
          ...
          <a href="{{ route('back-for-company-on-sale') }}" style="text-decoration: none; color:white;">
            <div class="card-body">
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    <h3 class="mb-0">{{$count_sell_for_client_not_in_cash}}</h3>
                  </div>
                </div>
                <div class="col-3">
                  <!-- Add any icons or elements if necessary -->
              ...
              <h6 class="text-muted font-weight-normal">Plots bought without hard cash</h6>
            </div>
          </a>
        </div>
      </div>
